...
module phys_module
  ...
  integer :: seed_type = 1                                            !< 1=flux perturbation (psiseed); 2=CLT resistivity perturbation
  ...
  real*8  :: seed_ampl_boost = 1.d0                                    !< amplification factor for psiseed psi_tilde (default=1)
  real*8  :: seed_amplitude = 1.d0                                    !< seed perturbation amplitude
  real*8  :: seed_eta10 = 0.d0                                         !< resistivity perturbation amplitude for seed_type=2 (CLT style)

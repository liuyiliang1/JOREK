...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(seed_type,              1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(seed_ampl_boost,1              ,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_eta10,     1              ,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,seed_type,              1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,seed_ampl_boost,1              ,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_eta10,     1              ,MPI_REAL8  ,MPI_COMM_WORLD,ierr)

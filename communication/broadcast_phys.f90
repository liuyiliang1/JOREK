...
if (my_id .eq. 0) then
  ...
  call MPI_PACK(slave_impurity_conc,    1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(slave_impurity_omega,   1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(visco_sol,              1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(visco_sol_tanh_psin,    1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(visco_sol_tanh_sig,     1,MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_PACK(num_seed_islands,       1,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_amplitude, max_seed_islands,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_psin,      max_seed_islands,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_n_tor,     max_seed_islands,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_width,     max_seed_islands,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_m_pol,     max_seed_islands,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_q,         max_seed_islands,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_continuous,        1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(seed_type,      max_seed_islands,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(psiseed_width,  max_seed_islands,MPI_REAL8  ,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(slave_impurity,         1,MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(zeff_indices_kin,  n_aux_var_max,MPI_INTEGER,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  ...
  call MPI_PACK(part_group_configs%use_sheath,                 n_part_groups_max,     MPI_LOGICAL,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
  call MPI_PACK(part_group_configs%ics_concentration,          n_part_groups_max,     MPI_REAL8,buffer,bufsize,position,MPI_COMM_WORLD,ierr)
...
if (my_id .ne. 0) then
  ...
  call MPI_UNPACK(buffer,bufsize,position,slave_impurity_conc,    1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,slave_impurity_omega,   1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,visco_sol,              1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,visco_sol_tanh_psin,    1,MPI_REAL8,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,visco_sol_tanh_sig,     1,MPI_REAL8,MPI_COMM_WORLD,ierr)
...
!==========================Added input for SPI model===========================================
  ...
  call MPI_UNPACK(buffer,bufsize,position,num_seed_islands,       1,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_amplitude, max_seed_islands,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_psin,      max_seed_islands,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_n_tor,     max_seed_islands,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_width,     max_seed_islands,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_m_pol,     max_seed_islands,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_q,         max_seed_islands,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_continuous,        1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,seed_type,      max_seed_islands,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,psiseed_width,  max_seed_islands,MPI_REAL8  ,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,slave_impurity,         1,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,zeff_indices_kin,        n_aux_var_max,MPI_INTEGER,MPI_COMM_WORLD,ierr)
  ...
  call MPI_UNPACK(buffer,bufsize,position,part_group_configs%use_sheath,                 n_part_groups_max,MPI_LOGICAL,MPI_COMM_WORLD,ierr)
  call MPI_UNPACK(buffer,bufsize,position,part_group_configs%ics_concentration,          n_part_groups_max,MPI_REAL8,MPI_COMM_WORLD,ierr)
